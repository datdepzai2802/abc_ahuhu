const footer = {
  render() {
    return `
        <section class="flex py-6 max-w-[1240px] m-auto mt-[30px]">
            ...
            <div class="flex mt-3">
                ...
                src="src/image/bo-cong-thuong-2.png"
                alt=""
                />
                <img class="max-w-[80px]" src="src/image/bo-cong-thuong.svg" alt="" />
            </div>
            </div>
            ...
            <div>
                <img class="max-w-[200px] mt-2" src="src/image/sprite.png" alt="" />
            </div>
            <h3 class="font-medium text-black text-base capitalize mt-3">
                dịch vụ giao hàng
            </h3>
            <div>
                <img class="max-w-[60px] mt-2" src="src/image/tikinow.png" alt="" />
            </div>
            </div>
            ...
            <div class="flex justify-between items-center mt-3">
                <div>
                <img class="max-w-[80%]" src="src/image/qrcode.png" alt="" />
                </div>
                <div class="flex flex-wrap">
                <img class="max-w-[70%] mb-2" src="src/image/appstore.png" alt="" />
